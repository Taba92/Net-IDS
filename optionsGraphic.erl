...
setupSettingsPanel(Parent,Dets)->
	SettingsPanel = wxPanel:new(Parent),
  	wxStaticText:new(SettingsPanel,?wxID_ANY,"Opzione",[{pos,{20,30}}]),
  	Opt=wxTextCtrl:new(SettingsPanel,?wxID_ANY,[{pos,{150, 30}}]),
	wxTextCtrl:setSize(Opt,210,37),
	wxStaticText:new(SettingsPanel,?wxID_ANY,"Valore",[{pos,{20,80}}]),
	...
	SetOpt=wxButton:new(SettingsPanel,2, [{label, "SETTA OPZIONE"}, {pos,{20, 190}}]),
...
setupUpdatesPanel(Parent)->
  	...
  	Fit=wxButton:new(UpdatesPanel,3, [{label, "ALLENA"}, {pos,{20, 30}}]),
  	...
  	Dataset=wxButton:new(UpdatesPanel,5, [{label, "CREA NUOVO\n DATASET"}, {pos,{20, 250}}]),
